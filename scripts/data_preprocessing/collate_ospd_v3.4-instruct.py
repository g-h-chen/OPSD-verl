...
def main() -> None:
    ...
    parser.add_argument(
        "--output",
        default="/home/efs/hardychen/workspaces/gptoss_rlp/verl-internvl/datasets/rlp/v3.4-instruct/train.parquet",
        help="Train parquet path.",
    )
    parser.add_argument(
        "--val-output",
        default="/home/efs/hardychen/workspaces/gptoss_rlp/verl-internvl/datasets/rlp/v3.4-instruct/validation.parquet",
    ...
    parser.add_argument(
        "--model-path",
        default="/home/efs/hardychen/models/InternVL3_5-4B-Instruct",
