...
class PrefixRayPPOTrainer:
    ...
    def _dump_generations(self, inputs, outputs, scores, extra_infos, reward_extra_infos_dict, dump_path):
    ...
    def _validate(self):
        ...
        for test_batch, test_gen_batch in self.val_dataloader:
            ...
            # multi_modal_key_name = "multi_modal_data"
            # if multi_modal_key_name in test_batch.non_tensor_batch:
            #     non_tensor_batch_keys_to_pop.append(multi_modal_key_name)
...
# attention_mask = test_gen_batch.batch["attention_mask"]
...
# input_texts = [self.tokenizer.decode(ids, skip_special_tokens=False) for ids in input_ids]
    ...
    def fit(self):
        ...
        for epoch in range(self.config.trainer.total_epochs):
            ...
            for batch, gen_batch in self.train_dataloader:
                do_profile = (
                ...
                with marked_timer("step", timing_raw):
                    ...
                    if not repeat_sampling_sglang_grpo:
                        if "uid" not in batch.non_tensor_batch.keys():
