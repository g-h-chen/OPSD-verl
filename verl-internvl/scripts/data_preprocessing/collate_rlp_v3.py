...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Collate RLP v3 generations into train/val parquet."
    )
    parser.add_argument(
        "--input",
        default=(
    ...
    parser.add_argument(
        "--output",
        default="/home/efs/hardychen/workspaces/gptoss_rlp/verl-internvl/datasets/rlp/v3/train.parquet",
        help="Train parquet path.",
    )
    parser.add_argument(
        "--val-output",
        default="/home/efs/hardychen/workspaces/gptoss_rlp/verl-internvl/datasets/rlp/v3/validation.parquet",
