...
def main() -> None:
    ...
    parser.add_argument(
        "--output",
        default=(
            # "/home/efs/hardychen/workspaces/gptoss_rlp/verl-internvl/datasets/rlp/v3/allava_laion_caption_375k_rlp_v3_generation.jsonl"
            "/home/efs/hardychen/workspaces/gptoss_rlp/verl-internvl/datasets/rlp/v3/allava_vflan_caption_195k_rlp_v3_generation.jsonl"
        ),
        help="Output jsonl path.",
    )
    parser.add_argument(
        "--image-root",
        default="/home/efs/hardychen/workspaces/gptoss_rlp/InternVL/internvl_chat_gpt_oss/data/ALLaVA-4V",
        help="Image root for resolving paths.",
    )
...
'''
python /home/efs/hardychen/workspaces/gptoss_rlp/verl-internvl/scripts/data_preprocessing/generate_rlp_v3.py --image-root "/home/efs/hardychen/workspaces/gptoss_rlp/InternVL/internvl_chat_gpt_oss/data/ALLaVA-4V/allava_vflan"
